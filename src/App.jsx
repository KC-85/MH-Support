const supportPathways = [
  {
    ...
    description:
      'Understand common experiences through clear, plain-language information.',
  },
  {
    number: '02',
    title: 'Try something practical',
    description:
      'Find grounded ideas that feel realistic, manageable and useful right now.',
  },
  {
    number: '03',
    title: 'Know where to turn',
    description:
      'Explore straightforward routes towards trusted services and further help.',
  },
]
...
function BrandMark() {
  return (
    <span
      className="grid size-11 shrink-0 place-items-center rounded-full border-2 border-ink text-ink"
      aria-hidden="true"
    >
          ...
          <div className="mx-auto max-w-7xl">
            <div className="grid gap-8 lg:grid-cols-[0.7fr_1.3fr] lg:gap-20">
              ...
              <div>
                ...
                <p className="mt-6 max-w-2xl text-lg leading-8 text-muted">
                  Start with what feels most useful. There is no correct order
                  and no pressure to do everything at once.
                </p>
              </div>
            </div>
            ...
            <ol className="mt-16 grid border-y-2 border-ink/20 lg:grid-cols-3 lg:divide-x lg:divide-ink/20">
              {supportPathways.map((pathway) => (
                <li className="border-b border-ink/20 py-8 last:border-b-0 lg:border-b-0 lg:px-8 lg:first:pl-0 lg:last:pr-0" key={pathway.number}>
            ...
            <div className="grid gap-8 lg:grid-cols-[0.7fr_1.3fr] lg:gap-20">
              ...
              <div>
                ...
                <p className="mt-8 max-w-3xl text-lg leading-8 text-cream/90">
                  ...
                  We make common experiences easier to understand and help
                  people find a sensible next step without unnecessary jargon,
                  pressure or judgement.
                </p>
              </div>
            </div>

            <div className="mt-16 grid overflow-hidden rounded-[2rem] border border-cream/30 lg:grid-cols-2">
              ...
              <article className="border-t border-cream/30 p-8 sm:p-10 lg:border-l lg:border-t-0 lg:p-12">
                ...
                <p className="mt-6 max-w-xl leading-7 text-cream/90">
                  Health services and access pathways are not identical across
                  the UK. We make the relevant nation and eligibility clear so
                  people are not sent towards advice that does not apply to
                  them.
                </p>
            ...
            <div className="mt-14 grid border-y border-cream/30 lg:grid-cols-3 lg:divide-x lg:divide-cream/30">
              <article className="border-b border-cream/30 py-8 lg:border-b-0 lg:pr-8">
                ...
                <p className="mt-3 leading-7 text-cream/80">
                  We explain unfamiliar terms and keep sentences direct,
                  readable and free from avoidable clinical language.
                </p>
              </article>
              ...
              <article className="py-8 lg:pl-8">
                ...
                <p className="mt-3 leading-7 text-cream/80">
                  MH Support provides general information and signposting. It
                  does not diagnose conditions, provide treatment or replace
        ...
        <div className="mx-auto grid max-w-7xl gap-10 py-12 sm:grid-cols-2 sm:items-end">
          <div>
            <a
              ...
              aria-label="MH Support home"
            >
              <span className="grid size-11 place-items-center rounded-full border-2 border-cream">
